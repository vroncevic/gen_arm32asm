...
Info
    Defines a GenARM32ASMBundle bundle for the CLI application.
'''
...
@dataclass
class GenARM32ASMBundle:
    '''
        GenARM32ASMBundle holding all components (adapters and services) of the CLI application.
    ...
    def merge(self, other: 'GenARM32ASMBundle') -> None:
        '''
            Merges non-None values from another bundle into this one.

            :param other: Another bundle to merge into this one.
            :type other: <GenARM32ASMBundle>
            :exceptions: None.
        '''
